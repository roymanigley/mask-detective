...
def negativeImagesWidth = 120
def negativeImagesHeight = 120
def positiveImagesWidth = 50
def positiveImagesHeight = 10
...
println "opencv_createsamples -img pos/nerf-rect.jpg \\"
println "   -bg bg.txt \\"
...
println "   -num 1300 \\"
println "   -w ${positiveImagesWidth / 2} \\"
println "   -h ${positiveImagesHeight / 2} \\"
    ...
    forEachLink(negativeImagesUrl) { link ->
        runnables.add({
            try {
                ...
                resize(fileName, fileName, negativeImagesWidth, negativeImagesHeight)
            } catch (Exception e) {
